...
for candidate_index in range(len(candidate_list)):
    print(candidate_list[candidate_index] + ": " + str(format(round(100*candidate_votes_list[candidate_index]/total_number_of_votes,3), '.3f')) + "% (" + str(candidate_votes_list[candidate_index]) + ")" )
    OutputFile.write(candidate_list[candidate_index] + ": " + str(format(round(100*candidate_votes_list[candidate_index]/total_number_of_votes,3), '.3f')) + "% (" + str(candidate_votes_list[candidate_index]) + ")\n" )
